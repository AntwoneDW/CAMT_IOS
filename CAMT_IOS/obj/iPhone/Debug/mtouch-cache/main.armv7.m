...
extern void *mono_aot_module_CAMT_IOS_info;
...
{
	mono_aot_register_module (mono_aot_module_CAMT_IOS_info);
...
void monotouch_register_assemblies ()
{
	...
	monotouch_open_and_register ("ZipArchive.dll");
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "CAMT_IOS.exe";
	mono_use_llvm = FALSE;
